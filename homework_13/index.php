...
<body>
	<div class="social-media-menu">
		...
		<div class="menu-list">
			<ul>
				<li>
					<a href="https://www.facebook.com/pg/visitbaltics.net/about/" target="_blank"></a>
				</li>
				<li>
					<a hef="https://www.instagram.com/explore/tags/baltics/" target="_blank"></a>
				</li>
				<li>
					<a href="https://www.pinterest.co.uk" target="_blank"></a>
				</li>
				<li>
					<a href="https://visitbaltics.net/" target="_blank"></a>
				</li>
			</ul>
		</div>
	</div>
	<div class="container">
		<div class="top-nav">
			<ul>
				...
				<li><a href="gallery.html" class="gallery-link">Галерея</a></li>
				<li><a href="#" class="positioning-link">Позиционирование</a>
					<ul>
						<li><a href="#" class="basic-link">Basic</a>
							<ul>
		...
		<h1 class="text-on-background">О СТРАНАХ БАЛТИИ</h1>
		<p>
			Латвия, Эстония и Литва — это волшебное туристическое направление для истинных ценителей природы, которые готовы к приключениям. Здесь вы найдете множество нетронутых, первобытных мест для изучения разнообразного растительного и животного мира, суши и водного мира, которые существуют наряду с развитой городской инфраструктурой. Данные страны богаты лиственными и хвойными лесами. В Литве насчитывается более 3000 озер, в Эстонии более 1500 островов, а протяженность латвийского пляжа превышает 500 километров.
		</p>
		<div class="country-info">
			...
			<a href="gallery.html#latvia">Фотографии Латвии</a>
		</div>
		<div class="country-info">
			<h2>Эстония</h2>
			<p>
			...
			<a href="gallery.html#estonia">Фотографии Эстонии</a>
		</div>
		<div class="country-info">
			<h2>Литва</h2>
			<p>
			...
			<p>
				На побережье Балтийского моря находится уникальный природный памятник — Куршская коса. Она простираются на 98 километров и является самой высокой в Европе, в некоторых местах превышая 60 метров. Зачастую на открытом воздухе можно встретить бобров и белых аистов. В Литве самая плотная популяция белых аистов по всей Европе. В Литве по-прежнему встречаются европейские зубры, самые большие дикие звери в Европе, которые в настоящее время включены в Красную книгу.
			</p>
			<a href="gallery.html#lithuania">Фотографии Литвы</a>
		</div>
		<div class="links-list">
			<p>Узнать больше можно на официальных туристических сайтах</p>
			<ul>
				<li><a href="https://www.visitestonia.com" target="_blank"></a></li>
				<li><a href="https://www.latvia.travel"  target="_blank"></a></li>
				<li><a href="https://lithuania.travel"  target="_blank"></a></li>
			</ul>
		</div>
	</div>
</body>
